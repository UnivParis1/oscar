    ...
    def handle(self, user_input, entity_type):
        ...
        if operator == ":":
            ...
            for value in values:
                ...
                self.output_handler.format(entity_type=entity_type, field=field_name, value=value, entities=entities_gen)
        elif operator == "=":
            ...
            self.output_handler.format(entity_type=entity_type, field=field_name, value=user_value,
                                       entities_gen=entities_gen, nb_modules=self.data_service.module_manager.nb_modules)
